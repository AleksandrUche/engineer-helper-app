...
class RingWeightWidget(QWidget):
    def __init__(self):
        ...
        self.Images.setPixmap(
            QtGui.QPixmap(resource_path("images_vesseles/ring_weight_diameter.png")))
        ...
        self.gridLayout.addItem(spacer_item1, 6, 2, 1, 1)
        self.label_4 = QtWidgets.QLabel(self)
        self.label_4.setAlignment(QtCore.Qt.AlignRight | QtCore.Qt.AlignTrailing | QtCore.Qt.AlignVCenter)
        self.label_4.setObjectName("label_4")
        self.gridLayout.addWidget(self.label_4, 1, 1, 1, 1)
        self.input_field_d2 = QtWidgets.QLineEdit(self)
        self.input_field_d2.setObjectName("input_field_d2")
        self.gridLayout.addWidget(self.input_field_d2, 1, 2, 1, 1)
        ...
        self.gridLayout_2.addItem(spacer_item2, 5, 1, 1, 1)
        self.links_to_elements()
        self.retranslateUi()
        QtCore.QMetaObject.connectSlotsByName(self)
        self.setTabOrder(self.input_field_d, self.input_field_d2)
        self.setTabOrder(self.input_field_d2, self.input_field_s)
    ...
    def retranslateUi(self):
        ...
        self.label.setText(_translate("Form", "Масса кольца укрепляющего"))
        ...
        self.label_4.setText(_translate("Form", "Диаметр D, мм:"))
