...
class ProfilePipeWidget(QWidget):
    ...
    def __init__(self):
        ...
        self.Images.setText("")
        self.Images.setPixmap(QtGui.QPixmap(resource_path("images_metal_rolling/profile_pipe.png")))
        ...
        self.gridLayout.addItem(spacer_item2, 4, 2, 1, 1)
    ...
    def retranslateUi(self):
        ...
        self.label.setText(_translate("Form", "Расчет массы профильной трубы"))
    ...
    def calculate_mass(self):
        try:
            ...
            side_a = Decimal(self.input_field_a.text())
            ...
            result = calculate_mass_profile_pipe(side_a, side_b, thickness, length, rounding)
