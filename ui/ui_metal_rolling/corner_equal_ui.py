...
class CornerEqualWidget(QWidget):
    def __init__(self):
        super().__init__()
        ...
        self.Images.setText("")
        self.Images.setPixmap(QtGui.QPixmap(resource_path("images_metal_rolling/corner.png")))
        ...
        self.setTabOrder(self.input_field_a, self.input_field_s)
    ...
    def retranslateUi(self):
        ...
        self.label.setText(_translate("Form", "Расчет массы уголка равнополочного"))
    ...
    def calculate_mass(self):
        try:
            ...
            result = calculate_mass_corner_equal(side, thickness, length, rounding)
